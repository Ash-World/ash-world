---
title: "Linguistic Prompts"
description: "언어학(통사론·의미론·화용론)의 핵심 개념을 프롬프트 엔지니어링에 적용하는 방법론과 그 시사점을 탐구한 글"
publishDate: 2025-02-23
tags: ["Research", "LLM", "Prompt"]
draft: false
---

![Linguistic Prompts](/ash-world/assets/liguistic prompts.png)
