---
title: "그래서 제일 좋은 Chunking이 뭔데?"
description: "6가지 Chunking Strategy(Naive, Fixed Size, Overlap, Recursive, Sentence Window, Semantic)를 직접 실험하고 RC-Score로 종합 비교한 결과를 공유하는 글"
publishDate: 2024-12-21
tags: ["Research", "RAG", "Chunking"]
draft: false
---

![그래서 제일 좋은 chunking이 뭐야?](/ash-world/assets/dddd (1).png)
...
![[ Fig. 02 ] Naive Chunking 방식에 따른 chunk length](/ash-world/assets/image (132).png)

* **Fixed Size Chunking**

![[ Fig. 03 ] Fixed Size Chunking 방식에 따른 chunk length](/ash-world/assets/image (133).png)

* **Fixed Size Chunking with Overlap**

![[ Fig. 04 ] Fixed Size Chunking with Overlap 방식에 따른 chunk length](/ash-world/assets/image (134).png)

* **Recursive Chunking**

![[ Fig. 05 ] Recursive Chunking 방식에 따른 chunk length](/ash-world/assets/image (135).png)

* **Sentence Window Chunking**

![[ Fig. 06 ] Sentence Window Chunking 방식에 따른 chunk length](/ash-world/assets/image (136).png)

* **Semantic Chunking**

![[ Fig. 07 ] Semantic Chunking 방식에 따른 chunk length](/ash-world/assets/image (137).png)
...
****최종적으로 정량평가에서 Chunk의 길이 분포를 배제하였다.****

### ⅱ) 종합결과

 실험결과를 보자.

![[ Fig. 08 ] RC-Score from each chunking strategies](/ash-world/assets/image (14).png)
