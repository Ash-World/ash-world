---
title: "RAG 평가지표 정복하기"
description: "RAG 시스템의 Data(Chunking), Retrieval(Rank Aware/Unaware), Generation(Task/Domain specific) 3가지 카테고리에 걸친 평가지표를 총정리한 글"
publishDate: 2025-03-29
tags: ["Research", "RAG", "LLM"]
draft: false
---

![RAG 평가지표 정복하기](/ash-world/assets/goto_eval.png)
